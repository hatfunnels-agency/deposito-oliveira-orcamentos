...
;
  ...
  const imprimirOrcamento = (detalhe?: OrcamentoDetalhe | null) => {
    ...
    const condicaoPagLabelImp: Record<string,string> = {a_vista:'À vista',na_entrega:'Na entrega',prazo:'A prazo'};
